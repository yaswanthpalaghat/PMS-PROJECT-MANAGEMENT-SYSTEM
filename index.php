...
<!-- Mirrored from thegenius.co/industry-html/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Jul 2018 16:57:58 GMT -->
<head>
  ...
  <div class="nav-bar">
    <div class="container">
      <div class="row">
        <div class="col-sm-4">
          <div class="logo">
            <a href="index.html"><img height="43" width="191" src="images/logo.png" alt="logo"></a>
          </div>
        </div>
        <div class="col-sm-8">
        <div class="row">
           <div class="col-sm-3">
            <div class="info-nav">
              ...
              <div class="info-nav-dtl"><a href="tel:#">9533112191</a></div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="info-nav">
              <div class="info-nav-heading">Email Address:</div>
              <div class="info-nav-dtl"><a href="mailto:#">projectgeek.tech@gmail.com</a></div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="info-nav">
              <div class="info-nav-heading">Contact</div>
              <div class="info-nav-dtl">YASWANTH SAI PALAGHAT</div>
            </div>
          </div>
    	      <div class="col-sm-3">
    	       	<a href="#" class="btn btn-default pull-right" data-toggle="modal" data-target="#request-model">Expert Advise</a>
    	      </div>
          </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h5 class="modal-title text-center">Get Expert Advise</h5>
            </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="counter-section">
              <h2 class="counter-heading"><span>Find the Right Project Idea  </span> @ the Right Place.</h2>
            </div>
          </div>
...
<!--  slider -->
  <section id="home-slider" class="home-slider">
    <div class="item home-slider-bg" style="background-image: url('images/bg/image.jpg'); height: 550; width: 1920; ">  
      <div class="container">
    ...
    <div class="item home-slider-bg" style="background-image: url('images/bg/slide2.jpg'); height: 550; width: 1920;">  
      <div class="container">
...
<section id="about" class="about-main-block">
    ...
    <div class="row">
      <div class="col-md-4 col-sm-6">
        <div class="about-block">
          ...
          <p>Engineers use our Projects to upgrade their knowledge on desired software development area to enhance their skills open up career options for a better future. </p>
          <p>Our platform enables students to increase their knowledge on projects. Students can share their projects with our platform and they can get advise from the experts regarding their projects,which helps in smooth completion of their project.</p>
            ...
            <div class="col-xs-3">
             ...
             <div class="col-xs-9">
              <div class="about-features-dtl">
                ...
                <p>Get the best advise for your Project and other projects.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-xs-3">
             ...
             <div class="col-xs-9">
              <div class="about-features-dtl">
                ...
                <p>Check status of on going projects and their completion time.</p>
              </div>
            </div>
          </div>
        </div>          
  ...
  <div  class="container-fluid">
    <center><h2 style="color: #ECC53F;"><b>Latest Projects</b></h2></center>
  </div>
  <div style="margin-top:10px; " class="container">
    <center><h2 style="color: #ECC53F;">Project Summary</h2></center>
    ...
    <table style="margin-top:30px;" class="table table-bordered">
      ...
      <tbody>
        <tr>
          <td>01</td>
          <td><a href="#"> FLASK-CAPTION GENERATION</a></td>
          <td>B.TECH CSE</td>
  ...
  <a href="#" class="fa fa-linkedin"></a></td>
        ...
        <tr>
          <td>02</td>
          <td><a href="#">OBJECT DETECTION SYSTEM</a> </td>
          <td>B.TECH CSE</td>
         <td><a href="#" class="fa fa-facebook"></a>
  <a href="#" class="fa fa-twitter"></a>
  <a href="#" class="fa fa-google"></a>
  <a href="#" class="fa fa-linkedin"></a></td>
         ...
         <tr>
          <td>03</td>
          <td><a href="#">ATTENDANCE MARKING SYSTEM</a></td>
          <td>B.TECH CSE</td>
         <td><a href="#" class="fa fa-facebook"></a>
  <a href="#" class="fa fa-twitter"></a>
  <a href="#" class="fa fa-google"></a>
  ...
  <div  style="margin-top:10px; " class="container">
    ...
    <table style="margin-top:30px; "class="table table-bordered">
      <thead>
        <tr>
          <th style="color:green" >S.No</th>
          <th style="color:green">Project Name And Details</th>
          <th style="color:green">Programme</th>
          <th style="color:green">Share</th>
        </tr>
      </thead>
      <tbody>
  ...
  <a href="#" class="fa fa-linkedin"></a></td>
        ...
        <tr>
          <td>02</td>
          <td><a href="#"> EMOTION DETECTION SYSTEM</a></td>
          <td>B.TECH CSE</td>
         <td><a href="#" class="fa fa-facebook"></a>
  <a href="#" class="fa fa-twitter"></a>
  <a href="#" class="fa fa-google"></a>
  <a href="#" class="fa fa-linkedin"></a></td>
         ...
         <tr>
          <td>03</td>
          <td><a href="3">HANDWRITTEN DIGIT RECOGNITION </a></td>
          <td>B.TECH CSE</td>
         <td><a href="#" class="fa fa-facebook"></a>
  <a href="#" class="fa fa-twitter"></a>
  <a href="#" class="fa fa-google"></a>
      ...
      <div id="featured-slider" class="featured-slider">
        <div class="item featured-block"> 
          ...
          <div class="featured-dtl">
            <h5 class="featured-heading">01 OBJECT DESCRIPTION SYSTEM</h5>
        ...
        <div class="item featured-block"> 
          ...
          <div class="featured-dtl">
            <h5 class="featured-heading">02 TEXT TO SPEECH CONVERSION</h5>
            <a href="projects-details.html" class="btn btn-default">View Project</a>
          </div>
        </div>
        <div class="item featured-block"> 
          ...
          <div class="featured-dtl">
            <h5 class="featured-heading">03 SENTIMENT ANALYSIS USING NLP</h5>
            <a href="projects-details.html" class="btn btn-default">View Project</a>
          </div>
        </div>
        <div class="item featured-block"> 
          ...
          <div class="featured-dtl">
            <h5 class="featured-heading">04 ATTENDANCE MARKING SYSTEM</h5>
            <a href="projects-details.html" class="btn btn-default">View Project</a>
          </div>
        </div>
        <div class="item featured-block"> 
          ...
          <div class="featured-dtl">
            <h5 class="featured-heading">05 CAPTION GENERATION SYSTEM</h5>
            <a href="projects-details.html" class="btn btn-default">View Project</a>
          </div>
        </div>
        <div class="item featured-block"> 
          ...
          <div class="featured-dtl">
            <h5 class="featured-heading">06 FACE RECOGNITION SYSTEM</h5>
            <a href="projects-details.html" class="btn btn-default">View Project</a>
          </div>
        </div>
      </div>
        ...
        <div id="testimonials-slider" class="testimonials-slider">
          <div class="item">
            <div class="testimonial-block">
              ...
              <div class="testimonial-client-dtl">
                <div class="testimonial-client">P YASWANTH SAI <span>- Professor</span></div>
                <div class="rating">     
                  <ul>
          ...
          <div class="item">
            <div class="testimonial-block">
              ...
              <div class="testimonial-client-dtl">
                <div class="testimonial-client">Mr YASWANTH SHARMA <span>- Asst Professor</span></div>
                <div class="rating">     
                  <ul>
                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <div class="footer-about footer-widget">
              ...
              <p>Our platform enables students to increase their knowledge on projects. Students can share their projects with our platform and they can get advise from the experts regarding their projects,which helps in smooth completion of their project.
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-news footer-widget">
              ...
              <ul>
                <li><a href="#">SCHOOL OF AI SEMINAR AT NEC GUDUR </a> - July 15, 2018</li>
                <li><a href="#">The best choice to complete your project. </a> - June 25, 2018</li>
              </ul>           
            </div>
          </div>
          <div class="col-md-3 col-sm-6">
            <div class="footer-contact footer-widget">
              ...
              <ul class="footer-address">
                <li><span>Address:</span> Admin</li>
                <li><span>Call:</span> <a href="tel:#">9533112191</a></li>
                <li><span>Email:</span> <a href="mailto:#">info@pms.com</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="copyright-text">
              <p>Project Management System | &copy; 2018. | All Rights Reserved.</p>
            </div>
          </div>
          <div class="col-sm-6">
...
<!-- Mirrored from thegenius.co/industry-html/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Jul 2018 16:58:52 GMT -->
</html>