        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-contact footer-widget">
            ...
            <ul class="footer-address">
               <li><span>Address:</span> YASWANTH SAI PALAGHAT</li>
              <li><span>Call:</span> <a href="tel:#">9533112191</a></li>
              <li><span>Email:</span> <a href="mailto:#">projectgeek.tech@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="copyright-text">
            <p>FYP Management System | &copy; 2018. | All Rights Reserved.</p>
          </div>
        </div>
        <div class="col-sm-6">
...
<!-- Mirrored from thegenius.co/industry-html/html/projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Jul 2018 16:59:43 GMT -->
</html>